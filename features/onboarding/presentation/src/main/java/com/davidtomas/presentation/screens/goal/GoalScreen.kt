package com.davidtomas.presentation.screens.goal
        ...
        Column(
            ...
            Row {
                SelectableButton(
                    ...
                    onClick = { viewModel.onGoalClicked(GoalType.LoseWeight) },
                ...
                SelectableButton(
                    ...
                    color = MaterialTheme.colors.primaryVariant,
                    selectedTextColor = Color.White,
                    onClick = { viewModel.onGoalClicked(GoalType.KeepWeight) },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
                )
                ...
                SelectableButton(
                    ...
                    color = MaterialTheme.colors.primaryVariant,
                    selectedTextColor = Color.White,
                    onClick = { viewModel.onGoalClicked(GoalType.GainWeight) },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
                )
